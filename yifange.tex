...
\item Frontend engineer on iCloud.com and various web-based iCloud services.
\item Build beautiful UIs and the infrastructure to run them on.
\item Lead the development of core features and extensive cross-functional collaboration.
\item \textbf{Technology}: React, TypeScript, nodejs
